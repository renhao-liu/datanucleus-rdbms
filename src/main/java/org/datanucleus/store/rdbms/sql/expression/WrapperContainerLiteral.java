...
public class WrapperContainerLiteral extends WrapperContainerExpression implements SQLLiteral
{
    private Object value;

    public WrapperContainerLiteral(SQLStatement stmt, JavaTypeMapping mapping, Object value, String parameterName)
    {
